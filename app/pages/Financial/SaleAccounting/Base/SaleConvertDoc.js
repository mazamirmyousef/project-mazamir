...
const SaleConvertDoc = (props) => {
            ...
            <Row>
                <Col md={3}>
                    <InputSelect
                        label="شناسه فروش"
                        name="REC_TYPE"
                        url='/Common/GetSelectRec_Type_Convert_Doc'
                        filter=""
                        textField='desc'
                        valueField='id'
                    />
                ...
                <Col md={3}>
                      <InputSelect
                        label="نوع"
                        name="CONVERT_TYPE"
                        url='/Common/GetSelectConvert_Type'
                        filter=""
                        textField='desc'
                        valueField='id'
                    />
    ...
    return (<>
        ...
        <PopupCurd
            ...
            urls={{
                readUrl: "/Satrmnt/Show_Sale_Convert_Doc",
