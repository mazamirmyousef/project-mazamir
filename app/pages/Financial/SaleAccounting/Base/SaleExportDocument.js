...
const SaleExportDocument = (props) => {
            ...
            <Row>
                <Col md={3}>
                    <InputSelect
                        label="شناسه فروش"
                        name="REC_TYPE"
                        url='/Common/GetSelectRec_Type_Export_Doc'
                        filter=""
                        textField='desc'
                        valueField='id'
                        defaultValue="10"
    ...
    return (<>
        <div>
            ...
            <PopupCurd
                style={{ width: '200px' }}
                columns={columns}
                title="تعریف سند صادراتی"
                urls={{
                    readUrl: "/Satrmnt/Show_Sale_Export_Doc",
...
export default connect(mapStateToProps)(SaleExportDocument);
