...
const InputModalSelectGasub = (props) => {
    const { url, column, name, titleName, selectKey, selectLabel,selectColumn, label, ...rest } = props
    ...
    const confirmHandler = (data) => {
        ...
        dispatch(passIdsActions.fetchSelectData(data.GAMAIN_SRL));
        //redux
        setIsSelected(true)
...
export default InputModalSelectGasub;